...
def _montar_prompt(consulta: dict[str, Any], recomendacao: dict[str, Any]) -> str:
    return (
        ...
        "ou valor FOB.\n"
        "- confianca_minima é apenas o filtro escolhido pelo usuário para exibir "
        "resultados. Não interprete confianca_minima como a confiança da recomendação.\n"
        "- A confiança real da recomendação está no campo faixa_confianca.\n"
        "- Se faixa_confianca for ALTA, explique que há boa cobertura/consistência "
        "nos dados usados.\n"
        "- Se faixa_confianca for LIMITADA, avise que a recomendação exige validação "
        "complementar.\n"
        "- Se houver dado imputado, acordo neutro ou baixa cobertura, mencione isso "
        "com cautela.\n"
        ...
        "Formato desejado:\n"
        "1. Primeiro explique por que o país apareceu bem ranqueado, citando os "
        "principais componentes do score.\n"
        "2. Depois explique a confiança e os cuidados de interpretação.\n"
