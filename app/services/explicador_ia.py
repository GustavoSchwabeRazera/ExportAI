...
def _montar_prompt(consulta: dict[str, Any], recomendacao: dict[str, Any]) -> str:
    return (
        ...
        "como uma indicação baseada nos dados disponíveis. Seja objetivo, com 1 ou "
        "2 parágrafos.\n\n"
        ...
        "- Não informe números, valores, percentuais, rankings, índices, notas, "
        "quantidades ou valores FOB na explicação.\n"
        "- Não cite o Score ExportAI numericamente.\n"
        "- Não cite o índice de cobertura numericamente.\n"
        "- Não fale da confiança da recomendação.\n"
        "- Explique os componentes do resultado de forma qualitativa, sem citar "
        ...
        "Formato desejado:\n"
        "1. Explique por que o país apareceu bem ranqueado, em linguagem simples.\n"
        "2. Cite os fatores gerais que contribuíram para a recomendação, sem números.\n"
